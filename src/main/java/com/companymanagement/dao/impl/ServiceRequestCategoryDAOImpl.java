...
@Repository("ServiceRequestCategoryDAO")
public class ServiceRequestCategoryDAOImpl extends JPADAOImpl<Long, ServiceRequestCategory> implements ServiceRequestCategoryDAO {
