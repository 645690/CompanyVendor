...
@Repository("ServiceRequestStatusDAO")
public class ServiceRequestStatusDAOImpl extends JPADAOImpl<Long, ServiceRequestStatus> implements ServiceRequestStatusDAO {
