...
public interface BaseService<Long,E> {
	/**
	 * This allows business service impls to set JPA Entity Managers on daos only
	 * when business service impls are called from JUnit test cases that does not
	 * run in a J2EE conatiner. There is a need to do this since jUNit test cases
	 * 
	 * @param entityManager
	 * @throws Exception
	 */
	...
	/**
	 * Will not throw an exception if entity to be deleted is not found. Will return
	 * gracefully.
	 * 
	 * @param id
	 * @throws Exception
